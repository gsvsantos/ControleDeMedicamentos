...
public class ControladorRequisicaoSaida : Controller
{
    ...
    [HttpPost("cadastrar")]
    public IActionResult Cadastrar(CadastrarRequisicaoSaidaViewModel cadastrarVM, string btnSubmit)
    {
        List<Paciente> pacientes = repositorioPaciente.SelecionarRegistros();
        ...
        if (btnSubmit == "selecionarPaciente")
        {
        ...
        else if (btnSubmit == "selecionarPrescricao")
        {
            TempData["RequisicaoSaida"] = JsonSerializer.Serialize(cadastrarVM);
